# Script de push en commits multiples pour ClaraVerse V15
# Date: 23 Avril 2026
# Repository: https://github.com/sekadalle2024/Claverse_windows__v_14_23-04-2026_V5_docker_zeabur_ok_switch_editeur-.git

Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host "  Push ClaraVerse V15 en Commits Multiples                      " -ForegroundColor Cyan
Write-Host "  Date: 23 Avril 2026                                            " -ForegroundColor Cyan
Write-Host "=================================================================" -ForegroundColor Cyan
Write-Host ""

# Configuration
$repoUrl = "https://github.com/sekadalle2024/Claverse_windows__v_14_23-04-2026_V5_docker_zeabur_ok_switch_editeur-.git"
$branche = "master"
$commitPrefix = "Sauvegarde ClaraVerse V15 - 23 Avril 2026"
...
git add *.md *.txt "Doc_Github_Issue/" "Doc Koyeb deploy/" "deploiement-netlify/" "Doc backend github/" "Doc backend huggings face/"
